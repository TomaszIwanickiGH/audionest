        ...
        <div className="flex lg:flex-row flex-col items-center justify-between mt-16 gap-4">
          <div className="flex flex-col gap-6 items-center">
            ...
            <button
              ...
              onClick={() => {
                window.scrollTo(0, 0)
                setCurrentProduct({ price: '$ 289.99', image: images.HEX1, title: 'XX MARK I' })
              }}
            >
              See Product
            </button>
          ...
          <div className="flex flex-col gap-6 items-center">
            ...
            <button
              ...
              onClick={() => {
                window.scrollTo(0, 0)
                setCurrentProduct({ price: '$ 349.99', image: images.HEX2, title: 'XX59' })
              }}
            >
              See Product
            </button>
          ...
          <div className="flex flex-col gap-6 items-center">
            ...
            <button
              ...
              onClick={() => {
                window.scrollTo(0, 0)
                setCurrentProduct({ price: '$ 299.99', image: images.HEX3, title: 'X21 GEN 7' })
              }}
            >
              See Product
            </button>
