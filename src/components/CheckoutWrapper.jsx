        ...
        <div className="bg-white rounded-lg flex flex-col gap-4 sm:px-8 px-6 sm:py-8 py-6 mt-8 sm:min-w-[400px] min-w-[325px]">
          ...
          {allProducts.length !== 0 && (
            <>
              ...
              <button className="bg-secondary px-6 py-3 w-full text-white hover:text-primary hover:font-[500] lg:text-[16px] text-[14px] mt-4" onClick={() => console.log(allProducts.length)}>
                Continue & Pay
              </button>
            </>
          )}
