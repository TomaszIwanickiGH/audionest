        ...
        <div className="bg-white rounded-lg flex flex-col gap-4 sm:px-8 px-6 sm:py-8 py-6 mt-8 min-w-[400px]">
          ...
          <div className="flex gap-4">
            <div className="flex justify-center items-center bg-veryVeryLightGray w-[80px] h-[80px] rounded-lg">
              <img src={images.HEX1} alt="img" className="w-[65px] h-[55px]" />
            </div>
            <div className="flex flex-1 justify-between mt-2">
              <div>
                <p className="font-[600] text-[15px] text-primary">XX99 MK I</p>
                <p className="font-[500] text-[14px] text-veryLightGray mt-2">$ 299.99</p>
              </div>
              <p className="font-[500] text-[15px] text-veryLightGray">x1</p>
            </div>
          </div>
