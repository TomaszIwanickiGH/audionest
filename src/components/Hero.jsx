...
const Hero = () => {
  return (
    <section className="w-full bg-primary">
      ...
      <section
        id="home"
        className={`sm:px-24 px-8 mx-auto flex lg:flex-row flex-col-reverse justify-between items-center relative z-0 mt-4`}
      >
        <div
          // initial={{ opacity: 0, x: '-30%' }}
          // animate={{ opacity: 1, x: 0 }}
          // transition={{ duration: 1 }}
          className="flex flex-col lg:items-start items-center lg:mt-0 mt-8"
        >
